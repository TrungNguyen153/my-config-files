...
local preload = function()
	...
	keymap('n', '<localleader>n', '<cmd>lua require"configs.telescope".pickers.plugin_directories()<CR>', opts)
	keymap('n', '<localleader>w', '<cmd>lua require"configs.telescope".pickers.notebook()<CR>', opts)

	-- Navigation
	keymap('n', '<leader>/', '<cmd>Telescope current_buffer_fuzzy_find<CR>', opts)
	keymap('n', '<leader>gt', '<cmd>lua require"configs.telescope".pickers.lsp_workspace_symbols_cursor()<CR>', opts)
	keymap('n', '<leader>gf', '<cmd>lua require"configs.telescope".pickers.find_files_cursor()<CR>', opts)
	keymap('n', '<leader>gg', '<cmd>lua require"configs.telescope".pickers.grep_string_cursor()<CR>', opts)
	keymap('x', '<leader>gg', '<cmd>lua require"configs.telescope".pickers.grep_string_visual()<CR>', opts)
